...
split_properties.loc[split_properties['cluster'].isin(['bnst']), 'group'] = 1
split_properties.loc[split_properties['cluster'].isin(['nacc']), 'group'] = 0
split_properties['group'] = split_properties['group'].astype(int).copy()
scatter_contour(split_properties, mapping={1:'#D1A5B5', 0:'#A7A9AC'}, bounds=5)
